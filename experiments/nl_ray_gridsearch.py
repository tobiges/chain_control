...
#search_space = {
#    "state_dim": tune.grid_search([30, 40, 50, 80]),
#    "f_width_size": tune.grid_search(np.linspace(0.0, 100.0, 11)),
#    "f_depth": tune.grid_search([0, 1, 2]),
#    "g_width_size": tune.grid_search(np.linspace(0.0, 100.0, 11)),
#    "g_depth": tune.grid_search([0, 1, 2]),
#    "u_transform": tune.grid_search([lambda u: u, np.arctan]),
#    "constant_after": tune.grid_search([-1, 0, 3]),
#}
