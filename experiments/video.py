...
controller_all = eqx.tree_deserialise_leaves(
    f"../docs/multi_model_controller_all.eqx", controllerall)
controller_e1 = eqx.tree_deserialise_leaves(
    f"../docs/multi_model_controller_e1.eqx", controller1)
controller_e2 = eqx.tree_deserialise_leaves(
    f"../docs/multi_model_controller_e2.eqx", controller2)
controller_e3 = eqx.tree_deserialise_leaves(
    f"../docs/multi_model_controller_e3.eqx", controller3)
controller_e4 = eqx.tree_deserialise_leaves(
    f"../docs/multi_model_controller_e4.eqx", controller4)

model_e1 = eqx.tree_deserialise_leaves(
    f"../docs/multi_model_e1.eqx", model1)
model_e2 = eqx.tree_deserialise_leaves(
    f"../docs/multi_model_e2.eqx", model2)
model_e3 = eqx.tree_deserialise_leaves(
    f"../docs/multi_model_e3.eqx", model3)
model_e4 = eqx.tree_deserialise_leaves(
    f"../docs/multi_model_e4.eqx", model4)
